 ...
 * Run: node src/utils/minify-html-assets.js
 */
const fs = require('fs');
...
const HTML_FILES = [
  ...
  path.join('src', 'pages', 'contact-us.html'),
  path.join('src', 'pages', 'travel-insurance.html'),
  path.join('src', 'pages', 'visit-visa.html'),
  path.join('src', 'pages', 'study-visa.html'),
  path.join('src', 'pages', 'umrah-packages.html'),
  path.join('src', 'pages', 'hotel-bookings.html')
];
